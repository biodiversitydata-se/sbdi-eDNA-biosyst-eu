...
### Alpha diversity: Shannon index by habitat

*Within-sample diversity by habitat, complementing the between-sample (beta diversity) view above.*

![](figures/4b_shannon.png)
