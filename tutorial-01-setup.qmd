...
[RStudio Server](http://193.10.159.192:8787){target="_blank"}
...
Some figures later in the tutorial have several panels and can look cramped in the small Plots pane on a laptop screen — click **Zoom** above the pane to open the figure in a larger, resizable window.
...
If two (IBA_COI) zip files are listed, you are ready to proceed.
