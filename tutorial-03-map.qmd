...
This keeps 817 of the 826 homogenate samples. That's 1,631 samples going into the PCoA in the next step — possibly heavier than our shared workshop VM can comfortably handle at once, so we downsample each method evenly down to a lighter total:
