---
title: "4. Community structure (beta diversity)"
format:
  html:
    toc: false
---

*Analyse how community composition differs between samples — beta diversity — using a Spearman correlation-based dissimilarity and a Principal Coordinates Analysis (PCoA), following the approach used in earlier IBA analyses of this data.*
