...
The PCoA plots suggest differences associated with habitat, sampling date and latitude, whereas homogenate and lysate samples are largely mixed. Pooling the two extraction methods in the following analyses seems reasonable, although extraction effects along other PCoA axes cannot be ruled out.
